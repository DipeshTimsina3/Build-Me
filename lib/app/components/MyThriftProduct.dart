...
class MyThriftProduct extends StatelessWidget {
  final Thrift thrift;
  // final VoidCallback onDelete;

  const MyThriftProduct({Key? key, required this.thrift})
      : super(key: key);
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              color: Colors.red,
              onPressed: (){MyThriftProductController().deleteThrift(thrift.thriftproductId);}
            ),
          ],
        ),
      ),
